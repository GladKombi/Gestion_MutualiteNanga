...
<aside class="w-64 h-screen bg-white shadow-md fixed">
    <div class="p-6 font-bold text-xl text-green-700">Gestion Loyer</div>
    <nav class="mt-8 flex flex-col gap-2">
        <a href="home.php" class="px-4 py-2 hover:bg-green-100 rounded">home</a>
        <a href="Batiment.php" class="px-4 py-2 hover:bg-green-100 rounded">Bâtiments</a>
        <a href="Chambre.php" class="px-4 py-2 hover:bg-green-100 rounded">Chambres</a>
        <a href="Locataire.php" class="px-4 py-2 hover:bg-green-100 rounded">Locataires</a>
        <a href="Paiement.php" class="px-4 py-2 hover:bg-green-100 rounded">Paiements</a>
    </nav>
</aside>